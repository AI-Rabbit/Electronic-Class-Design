...
`timescale 1 ns / 1 ps
	...
	(
        ...
        input wire [7:0] dch1_in, dch2_in, // ad9288, dual channel, 8 bit, parallel, offset binary
        //DMA axis interface
        ...
        output wire [1:0] switch_ch1, switch_ch2,
...
// Instantiation of Axi Bus Interface S00_AXI
	...
	) osc_v1_0_S00_AXI_inst (
	
        .sclka(sclka), .sclkb(sclkb),
        .dch1_in(dch1_in), .dch2_in(dch2_in), // ad9288, dual channel, 8 bit, parallel, offset binary
        //DMA axis interface
        .mdma_axis_tvalid(mdma_axis_tvalid), .mdma_axis_tlast(mdma_axis_tlast),
        .mdma_axis_tdata(mdma_axis_tdata),
        .mdma_axis_tready(mdma_axis_tready),
        //fifo interface
        .mfifo_axis_tvalid(mfifo_axis_tvalid), .mfifo_axis_tlast(mfifo_axis_tlast),
        .mfifo_axis_tdata(mfifo_axis_tdata),
        .mfifo_axis_tready(mfifo_axis_tready),    
        .sfifo_axis_tvalid(sfifo_axis_tvalid), .sfifo_axis_tlast(sfifo_axis_tlast),
        .sfifo_axis_tdata(sfifo_axis_tdata),
        .sfifo_axis_tready(sfifo_axis_tready),
        .fifo_cnt(fifo_cnt),
	    .switch_ch1(switch_ch1), .switch_ch2(switch_ch2),

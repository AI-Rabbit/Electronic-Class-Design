...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set dch1_in_0 [ create_bd_port -dir I -from 7 -to 0 dch1_in_0 ]
  set dch2_in_0 [ create_bd_port -dir I -from 7 -to 0 dch2_in_0 ]
  ...
  set lcd_pwm [ create_bd_port -dir O -from 0 -to 0 lcd_pwm ]
  set lcd_vs [ create_bd_port -dir O lcd_vs ]
  set sclka_0 [ create_bd_port -dir O sclka_0 ]
  set sclkb_0 [ create_bd_port -dir O sclkb_0 ]
  set switch_ch1_0 [ create_bd_port -dir O -from 1 -to 0 switch_ch1_0 ]
  set switch_ch2_0 [ create_bd_port -dir O -from 1 -to 0 switch_ch2_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {278.312} \
   CONFIG.CLKOUT1_PHASE_ERROR {301.601} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {51.2} \
  ...
  set osc_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:osc:1.0 osc_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {124.999870} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#Quad SPI Flash#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#SD 0#UART 1#UART 1#unassigned#unassigned#Enet 0#Enet 0} \
  ...
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins fifo_generator_0/M_AXIS] [get_bd_intf_pins osc_0/fifo_slave]
  connect_bd_intf_net -intf_net osc_0_dma_master [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins osc_0/dma_master]
  connect_bd_intf_net -intf_net osc_0_fifo_master [get_bd_intf_pins fifo_generator_0/S_AXIS] [get_bd_intf_pins osc_0/fifo_master]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins PWM_0/PWM_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins osc_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net PWM_0_pwm [get_bd_ports lcd_pwm] [get_bd_pins PWM_0/pwm]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports lcd_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net dch1_in_0_1 [get_bd_ports dch1_in_0] [get_bd_pins osc_0/dch1_in]
  connect_bd_net -net dch2_in_0_1 [get_bd_ports dch2_in_0] [get_bd_pins osc_0/dch2_in]
  connect_bd_net -net fifo_generator_0_axis_data_count [get_bd_pins fifo_generator_0/axis_data_count] [get_bd_pins osc_0/fifo_cnt]
  connect_bd_net -net osc_0_sclka [get_bd_ports sclka_0] [get_bd_pins osc_0/sclka]
  connect_bd_net -net osc_0_sclkb [get_bd_ports sclkb_0] [get_bd_pins osc_0/sclkb]
  connect_bd_net -net osc_0_switch_ch1 [get_bd_ports switch_ch1_0] [get_bd_pins osc_0/switch_ch1]
  connect_bd_net -net osc_0_switch_ch2 [get_bd_ports switch_ch2_0] [get_bd_pins osc_0/switch_ch2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PWM_0/pwm_axi_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins osc_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins PWM_0/pwm_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins osc_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs osc_0/S00_AXI/S00_AXI_reg] SEG_osc_0_S00_AXI_reg
